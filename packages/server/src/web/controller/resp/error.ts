...
const ERRORS = {
	LEAD_EMAIL_NOT_FOUND: 'A lead with this email does not exist',
	EMAIL_TIMELINE_ALREADY_EXISTS: 'Email timeline already exists. You can only have one follow up email template for a given timeline.',
	HOST_ID_REQUIRED: 'Host ID is required. Please ensure you have provided a valid host id',
	ASSET_ID_NOT_FOUND: 'Asset ID is required. Please ensure you have provided a valid asset id',
	FILE_NAME_REQUIRED: 'File name is required. Please ensure you have provided a valid file name',
	INVALID_PHONE_NUMBER: 'Invalid phone number format. Must include country code (e.g., +1, +44, +81)',
	INVALID_REQUEST: 'Invalid request. Both imageBase64 and fileName are required',
	EVENT_ID_REQUIRED: 'Event ID is required',
	COURSE_NOT_FOUND: 'We could not find this course, please check the course id',
	ADMINS_NOT_ALLOWED: 'Administrators are not allowed to perform this action.',
	PROVIDE_SOME_LEADS_OR_TAGS: 'Please provide some leads or tags to send the email to',
	PROVIDE_SOME_EVENTS: 'Please provide at least one event to send the email to',
	...
	PODCAST_OR_COURSE_MEMBERSHIP_NOT_ALLOWED: 'A `podcast` or `course` price point are not allowed in events. Choose another membership',
	...
	TEAM_MEMBER_NOT_ALLOWED:
		"Ops, you are not allowed to access this team's resources. Confirm that you have access to this team and try again.",
	...
	MODULE_NOT_FOUND: 'Ops, this module does not exist, please check',
} as const;
...
const MAIL_CONTENT = {
	...
	SUBSCRIPTION_CANCELLED: {
		...
		body: `Your subscription has been successfully cancelled, and access to premium features will be revoked at the end of your billing period. We understand that circumstances change, but we'd love to have you back whenever you're ready. If you ever wish to return, you can easily re-subscribe from your account settings. In the meantime, if you have any questions or need assistance, feel free to reach out to our support team. Thank you for being a part of ${env.BRAND_NAME}, and we hope to see you again soon!`,
	},
	SUBSCRIPTION_ENDED: {
		subject: 'Your subscription has ended',
		title: 'Subscription Ended',
		subtitle: 'Your access to premium features has expired',
		body: `Your subscription has officially ended, and your access to premium features has been discontinued. We hope you enjoyed your time with ${env.BRAND_NAME}! If you'd like to continue benefiting from exclusive features, you can renew your subscription anytime by visiting your account settings. We'd love to have you back, and if you need any help re-subscribing or have any questions, don't hesitate to contact our support team. Thank you for being part of our community!`,
		buttonText: 'Ok, got it',
		buttonLink: `${env.FRONTEND_URL}`,
	},
	...
	SUBSCRIPTION_PAYMENT_SUCCEEDED: {
		...
		body: `Good news! Your latest subscription payment was processed successfully, and your access to ${env.BRAND_NAME}'s premium features remains active. Thank you for being a valued member of our community! If you ever need to review your billing details or update your payment method, you can do so in your account settings. We appreciate your continued support and hope you continue to enjoy all the features that ${env.BRAND_NAME} has to offer. If you have any questions, feel free to reach out to us.`,
		buttonText: 'Ok, got it',
		buttonLink: `${env.FRONTEND_URL}`,
	},
