...
export const uploadBusinessLogoValidator = zValidator('json', uploadBusinessLogoSchema);
...
export type UploadBusinessLogoBody = z.infer<typeof uploadBusinessLogoSchema>;
