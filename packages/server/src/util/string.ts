...
export const formatDate = (date: string | Date, format: DateFormat = 'YYYY DD MM HH:mm'): string => {
	...
	return format.replace(/YYYY|DD|MMM|MM|MMMM|HH|mm|ss|DDDD/g, (match) => replacements[match] || match);
};

export const formatDateToLocale = (date: string | Date, timezone: string = 'Europe/London'): string => {
