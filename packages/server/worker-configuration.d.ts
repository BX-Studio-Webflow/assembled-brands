/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2eeb1c21e38bdb7108ad44961e5932cd)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SECRET_KEY: "assembled-brands-secret-key";
		SENDGRID_API_KEY: "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";
		TRANSACTIONAL_EMAIL_TEMPLATE_ID: "d-85053bc3d243484cbe9e3d493ae3b56b";
		AWS_REGION: "us-east-1";
		R2_ACCOUNT_ID: "e8a9920aa94111ca60571c30408287d9";
		R2_SECRET_ACCESS_KEY_ID: "483f13b389c25d3f5f8e6e13ae9f50d3";
		R2_SECRET_ACCESS_KEY: "d536f41bdb3dc72b2079167f68f872eca9918ff855e156c27174c82a289f4c55";
		R2_BUCKET_NAME: "file-storage-bucket";
		FRONTEND_URL: "https://www.assembledbrands.com" | "https://bx-assembled.webflow.io";
		BRAND_NAME: "Assembled Brands";
		GOOGLE_CLIENT_EMAIL: "my-service-account@drive-intergration-480614.iam.gserviceaccount.com";
		GOOGLE_PRIVATE_KEY: "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n";
		GOOGLE_DRIVE_FOLDER_ID: "0AJXqL9jbHtG6Uk9PVA";
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_LEVEL" | "NODE_ENV" | "SECRET_KEY" | "SENDGRID_API_KEY" | "TRANSACTIONAL_EMAIL_TEMPLATE_ID" | "AWS_REGION" | "R2_ACCOUNT_ID" | "R2_SECRET_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET_NAME" | "FRONTEND_URL" | "BRAND_NAME" | "GOOGLE_CLIENT_EMAIL" | "GOOGLE_PRIVATE_KEY" | "GOOGLE_DRIVE_FOLDER_ID">> {}
}
