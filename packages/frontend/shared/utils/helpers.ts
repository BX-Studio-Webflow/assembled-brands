...
export const WARM_LEAD_EXCEL_MIME_TYPES = [WARM_LEAD_MIME.xls, WARM_LEAD_MIME.xlsx] as const;

export const WARM_LEAD_EXCEL_ACCEPT = '.xls,.xlsx';

export const WARM_LEAD_EXCEL_FORMAT_LABEL = 'Allowed file formats: EXCEL';

export const WARM_LEAD_EXCEL_INVALID_MESSAGE = 'Invalid file type. Allowed file formats: EXCEL';
...
export const WARM_LEAD_TEAM_LEADERSHIP_FORMAT_LABEL = 'Allowed file formats: PDF, PPT, WORD, EXCEL';
...
export const WARM_LEAD_CAP_TABLE_INVALID_MESSAGE = 'Invalid file type. Allowed file formats: EXCEL';
...
export const WARM_LEAD_BUSINESS_PLAN_FORMAT_LABEL = 'Supported formats: .pdf, .docx, or .pptx';

export const WARM_LEAD_BUSINESS_PLAN_INVALID_MESSAGE =
  'Invalid file type. Supported formats: .pdf, .docx, or .pptx';

export const WARM_LEAD_INTERNATIONAL_LOCATION_PLACEHOLDER = 'London, UK or Shanghai, China';

/** Overrides Webflow accept attributes so Google Sheets (.sheets) is not offered. */
export const configureWarmLeadExcelFileInput = (input: HTMLInputElement) => {
  input.accept = WARM_LEAD_EXCEL_ACCEPT;
};

export const configureWarmLeadExcelFileInputs = (...inputs: HTMLInputElement[]) => {
  for (const input of inputs) {
    configureWarmLeadExcelFileInput(input);
  }
};

export const configureWarmLeadFileInputAccept = (input: HTMLInputElement, extensions: string[]) => {
