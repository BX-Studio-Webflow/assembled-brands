...
var WARM_LEAD_INSTORE_VELOCITY_ACCEPT = [".xlsx", ".xls", ".pdf"];
var WARM_LEAD_INSTORE_VELOCITY_FORMAT_LABEL = "Allowed file formats: PDF, EXCEL";
var WARM_LEAD_INSTORE_VELOCITY_INVALID_MESSAGE = "Invalid file type. Allowed file formats: PDF, EXCEL";
var WARM_LEAD_BUSINESS_PLAN_MIME_TYPES = [
  WARM_LEAD_MIME.pdf,
  WARM_LEAD_MIME.pptx
];
var WARM_LEAD_BUSINESS_PLAN_ACCEPT = [".pdf", ".pptx"];
var WARM_LEAD_BUSINESS_PLAN_FORMAT_LABEL = "Allowed file formats: PDF, PPT";
var WARM_LEAD_BUSINESS_PLAN_INVALID_MESSAGE = "Invalid file type. Allowed file formats: PDF, PPT";
...
var initOptionalDocsPage = async () => {
  ...
  const uploadFile = async (file, documentType) => {
    const rule = documentType === "instore_velocity_reports" ? DOC_RULES.instore_velocity_reports : documentType === "business_plan" ? DOC_RULES.business_plan : void 0;
