...
var apiGetInvitation = (invitationId) => {
  return ApiService_default.fetchDataWithAxios({
    url: `/team/invitations/${invitationId}`,
    method: "get"
  });
};
async function apiAcceptTeamInvitation(invitationId) {
  return ApiService_default.fetchDataWithAxios({
    url: `/team/invitations/${invitationId}/accept`,
    method: "post"
  });
}
async function apiRejectTeamInvitation(invitationId) {
  return ApiService_default.fetchDataWithAxios({
...
// warm-lead/team-acknowledge-invitation/index.ts
var TeamMembersPage = async () => {
  ...
  const inviter_name = invitation.inviter ? `${invitation.inviter.first_name || ""} ${invitation.inviter.last_name || ""}`.trim() : inviterName || "The admin";
  ...
  if (!invitationId || !teamName || !inviterName) {
    ...
    errorText.textContent = "Ops! Invalid invitation link. Please recheck the invitation link or contact your team administrator.";
