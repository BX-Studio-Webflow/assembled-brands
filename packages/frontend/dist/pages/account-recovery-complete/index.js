...
async function apiForgotPassword(data) {
...
var initAccountRecoveryCompletePage = () => {
  ...
  const password = queryElement('[dev-target="password"]', form);
  const confirmPassword = queryElement('[dev-target="confirm-password"]', form);
  const errorText = queryElement('[dev-target="error-text"]', form);
  const resendLinkWrapper = queryElement('[dev-target="resend-link_wrapper"]', form);
  const resendLink = queryElement('[dev-target="resend-link"]', form);
  ...
  const showExpiredLinkRecovery = (message) => {
  ...
  const eyeIconPassword = queryElement('[dev-target="eye-icon-password"]', form);
  const eyeIconConfirmPassword = queryElement(
